...
- August 5, 2026: WLOS covered the independent monitor's public Q&A on HCA's ownership of Mission. Monitor rep Rachel Ryan said under the APA HCA is obligated not to sell Mission during the first 10 years (advisory board consent required) and is unaware of any HCA desire to sell; restated 2025 report potential noncompliance on service discontinuation and multiple Immediate Jeopardy designations. Source: https://wlos.com/news/local/independent-monitor-discusses-hcas-ownership-of-mission-hospital
- August 9, 2026: Washington Post / KFF Health News (Peter Whoriskey) published a major investigation on hospital monopoly pricing featuring Mission Hospital: under the same Blue Cross plan, a knee replacement was about $40,000 at Mission vs. roughly $16,000 at Catawba Valley Medical Center; UnitedHealthcare breast biopsy $7,500 vs. $1,700 and hernia repair $17,700 vs. $9,600; Rand 2024 commercial prices 334% of Medicare at Mission vs. 237% at Catawba (NC benchmark 280%). Traces 1998 Mission merger monopoly, 2015 repeal of state profit limits, and HCA's 2019 purchase of a "prepackaged monopoly." Features patient Marcelle Crago, employer Katie Button, Yale economist Zack Cooper, and Sen. Julie Mayfield / Reclaim Healthcare WNC. Prefer free KFF URL: https://kffhealthnews.org/health-industry/hospital-mergers-monopolies-drive-healthcare-costs-asheville-north-carolina/
- August 10, 2026: MarketBeat filing alert — Deane Retirement Strategies Inc. acquired a new Q2 stake of 12,298 HCA shares valued at ~$4.8 million (~2% of portfolio; 22nd-largest holding). Note: URL slug says "480-million" but article body is $4.80 million / ~$4,796,000 — use the $4.8M figure. Also notes continued institutional ownership (~62.73%), MarketBeat consensus "Moderate Buy" / avg target $465.59, and restates Q2 $20.23B revenue / $7.59 EPS plus $0.78 quarterly dividend. Source: https://www.marketbeat.com/instant-alerts/filing-deane-retirement-strategies-inc-invests-480-million-in-hca-healthcare-inc-hca-2026-08-10/
...
- National Nurses United Too Big to Care case study (evergreen reference): "HCA: The Vanguard of the Anticompetitive Model" documents HCA's national playbook — market domination, price increases, service cuts, aggressive billing — with a major Asheville/Mission section. Key facts: 58% of Asheville discharges; Mission service cuts and surprise bills after 2019; bedside collections; trauma activation fees up to $50,000; 15 trauma nurses left in 2020; ~79 doctors departed; Mission nurses unionized Sept 2020 (largest non-union Southern hospital win since 1975); Asheville class-action antitrust suits; HCA fraud settlement history. Source: https://toobig2care.org/hca-case-study/ — keep in newsItems and talking points as a reference resource unless displaced by clearly fresher Mission accountability news.`;
...
KEY OUTLETS TO CHECK (when searching): Asheville Watchdog, Blue Ridge Public Radio (BPR), NC Health News, WLOS (https://wlos.com/ — Asheville local TV / Mission & HCA coverage), Becker's Hospital Review (https://www.beckershospitalreview.com/ — HCA / Mission / for-profit hospital coverage), Dogwood Health Trust (https://dogwoodhealthtrust.org/ — Independent Monitor reports, community webinars, Mission sale compliance), Washington Post / KFF Health News (national Mission monopoly pricing coverage), National Nurses United / Too Big to Care (https://toobig2care.org/hca-case-study/ — HCA anticompetitive playbook case study with Mission section), NC DOJ / AG, CMS, HCA investor relations, MarketBeat (institutional / filing alerts), and related congressional coverage. Prefer primary publisher URLs. Always consider Dogwood / Affiliated Monitors Independent Monitor updates when fresh. Keep the August 9, 2026 WaPo/KFF monopoly-pricing investigation in newsItems (and a talking point) unless a clearly fresher Mission accountability story displaces it. Keep the NNU Too Big to Care HCA case study (https://toobig2care.org/hca-case-study/) in newsItems as a reference resource when space allows.
