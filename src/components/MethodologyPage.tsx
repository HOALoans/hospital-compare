    ...
    <div className="space-y-8">
      ...
      <section className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm sm:p-8">
        ...
        <p className="mt-3 text-slate-600">
          {SITE_NAME} uses public CMS Hospital Compare data (HCAHPS, infections, and
          readmissions). Peer averages are simple unweighted means across hospitals in each group
